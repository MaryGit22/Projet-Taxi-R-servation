...
class __TwigTemplate_ad77e4c21a94bdd1fd1d34a0d915c7c1 extends Template
{
    private $source;
    private $macros = [];
...
<li> Planifier son trajet via la plateforme <a href=\"";
        ...
        echo "\" class=\"text-decoration-none\">bienvenuetransport.fr</a>  qui permet de réserver un chauffeur après avoir comparé différentes offres, et de bénéficier d'un prix fixe connu à l'avance.</li>
</ul>
<br>
...
<div class=\"\"><img src=\"";
        // line 55
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("photos/bebe.png"), "html", null, true);
        echo "\" alt=\"picto\"><br>
Rehausseur (siège enfant)</div>
<div><img src=\"";
        // line 57
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("photos/wifi.png"), "html", null, true);
        echo "\" alt=\"picto\"><br>
Connexion wifi</div>
<div><img src=\"";
        // line 59
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("photos/chauffeur.png"), "html", null, true);
        echo "\" alt=\"picto\"><br>
...
";
    ...
    {
        return array (  137 => 59,  132 => 57,  127 => 55,  106 => 37,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
