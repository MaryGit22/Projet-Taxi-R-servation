...
class __TwigTemplate_84c14a1efc3a0913e981d390e9e5e26c extends Template
{
    private $source;
    private $macros = [];
...
<img src=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("photos/user.png"), "html", null, true);
        echo "\"  alt=\"user\">
    <p><strong> Nom : </strong> ";
        // line 12
    ...
    <p><strong>Adresse : </strong>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "user", [], "any", false, false, false, 16), "adresse", [], "any", false, false, false, 16), "html", null, true);
        echo "</p>
</div>
</div>
...
";
    ...
    {
        return array (  103 => 16,  99 => 15,  95 => 14,  91 => 13,  87 => 12,  83 => 11,  76 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% endblock %}", "security/profil.html.twig", "C:\\Users\\preet\\OneDrive\\Desktop\\projet\\templates\\security\\profil.html.twig");
    }
}
