...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TaxisController' => 'getTaxisControllerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bkVa3X9iPR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'taxis_photos' => (\dirname(__DIR__, 4).'/public/photos/taxis'),
